      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Aqui está um resumo das atividades de hoje.</p>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Acesse o sistema de gestão da Smylink</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 p-4 bg-purple-50 rounded-lg">
            <p className="text-sm font-medium text-purple-900 mb-2">Credenciais para Demo</p>
            <div className="text-sm text-purple-700 space-y-1">
              <p>
                <strong>Admin:</strong> carlos@inovatra.com.br
              </p>
              <p>
