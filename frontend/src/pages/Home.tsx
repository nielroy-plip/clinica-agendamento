        ...
        <div className="container text-center">
          <div className="max-w-4xl mx-auto fade-in-up">
            ...
            <p className="text-xl md:text-2xl mb-8 text-purple-100 leading-relaxed">
              Clínica odontológica moderna com tecnologia de ponta e 
              profissionais especializados para cuidar da sua saúde bucal.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/agendamento" className="btn btn-primary btn-lg bg-white text-purple-700 hover:bg-gray-100">
                Agende sua Consulta
              </Link>
            </div>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Por que escolher a Inovatra?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Descubra os diferenciais que fazem da nossa clínica a melhor escolha 
              para o seu tratamento odontológico.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                A Clínica Inovatra nasceu do sonho de oferecer tratamentos 
